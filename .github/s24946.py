...
SPREADSHEET_ID = '1vOeIryS6mLWK_BPaULsBX_DD0ZH7Dr1OtmB9QU0TaeY'
...
def main():
    ...
    parser.add_argument('--standardize', action='store_true', help='Ścieżka do pliku CSV do czyszczenia i standaryzacji danych')
